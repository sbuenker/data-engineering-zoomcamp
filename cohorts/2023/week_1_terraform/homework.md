...
var.project
  ...
  Enter a value: de-zoomcam-376921
...
Terraform will perform the following actions:
  ...
  + resource "google_storage_bucket" "data-lake-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "EUROPE-WEST6"
      + name                        = "dtc_data_lake_de-zoomcam-376921"
...
google_storage_bucket.data-lake-bucket: Creation complete after 2s [id=dtc_data_lake_de-zoomcam-376921]
google_bigquery_dataset.dataset: Creation complete after 2s [id=projects/de-zoomcam-376921/datasets/trips_data_all]
